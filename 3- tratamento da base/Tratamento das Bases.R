...
#Consolida as bases
base_consolidada_sol <- bind_rows(base_marco,base_abril,base_maio) %>% filter(tipo=='solicitacao')
base_consolidada_oc <- bind_rows(base_marco,base_abril,base_maio) %>% filter(tipo=='oc')
rm(base_maio,base_abril,base_marco)
